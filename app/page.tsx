...
const MOCK_DEALS = [
  ...
  {
    id: 2,
    title: "Fresh Fits, Student Prices",
    brand: "ASOS",
  ...
  },
  {
    ...
    color: "bg-gray-900",
    logo: null,
    discountValue: "Education Pricing"
  },
  {
    id: 4,
         ...
         <div className="relative w-full h-[300px] md:h-[400px] overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-10">
                ...
                <p className="text-white/90 text-lg md:text-xl font-medium max-w-2xl drop-shadow-md">
                    Unlock exclusive student discounts, experiences, and more. 
                    Verify your status instantly.
                </p>
            </div>
         </div>
      </section>
      ...
      <main className="max-w-[1440px] mx-auto px-4 py-12">
         <div className="flex items-end justify-between mb-8">
            <div>
                ...
                <p className="text-slate-500 text-sm mt-1"> Discounts of this week.</p>
            </div>
         </div>
